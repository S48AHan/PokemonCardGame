...
const pokemon1Texture = textureLoader.load('./assets/Electric1.jpg');
pokemon1Texture.colorSpace = SRGBColorSpace;

const pokemon2Texture = textureLoader.load('./assets/Electric2.jpg');
pokemon2Texture.colorSpace = SRGBColorSpace;

const pokemon3Texture = textureLoader.load('./assets/Electric3.jpg');
pokemon3Texture.colorSpace = SRGBColorSpace;

const pokemon4Texture = textureLoader.load('./assets/Electric4.jpg');
pokemon4Texture.colorSpace = SRGBColorSpace;

const coverTexture = textureLoader.load('./assets/backCard.png');
...
const card1Mat = [
    ...
    new MeshBasicMaterial(),
    new MeshBasicMaterial(),
    new MeshBasicMaterial({map: waterTexture}),
...
const card2Mat = [
    ...
    new MeshBasicMaterial(),
    new MeshBasicMaterial(),
    new MeshBasicMaterial({map: pokemon1Texture}),
    new MeshBasicMaterial({map: coverTexture})
];
...
const card3Mat = [
    ...
    new MeshBasicMaterial(),
    new MeshBasicMaterial(),
    new MeshBasicMaterial({map: pokemon2Texture}),
    new MeshBasicMaterial({map: coverTexture})
];
...
const card4Mat = [
    ...
    new MeshBasicMaterial(),
    new MeshBasicMaterial(),
    new MeshBasicMaterial({map: pokemon3Texture}),
    new MeshBasicMaterial({map: coverTexture})
];
...
const card5Mat = [
    ...
    new MeshBasicMaterial(),
    new MeshBasicMaterial(),
    new MeshBasicMaterial({map: pokemon4Texture}),
    new MeshBasicMaterial({map: coverTexture})
];
...
const card6Mat = [
    ...
    new MeshBasicMaterial(),
    new MeshBasicMaterial(),
    new MeshBasicMaterial({map: fireTexture}),
    new MeshBasicMaterial({map: coverTexture})
];
...
configureCard(card1, myCardsPositions, myCardsRotations, randomNumber1, 'hand playerCard1 Water');
...
configureCard(card2, myCardsPositions, myCardsRotations, randomNumber1, 'hand playerCard2 Electric');

const card3 = new Mesh(cardGeo, card3Mat);
maximum1 = myCardsPositions.length - 1;
randomNumber1 = Math.floor(Math.random() * (maximum1 - minimum + 1)) + minimum;
configureCard(card3, myCardsPositions, myCardsRotations, randomNumber1, 'hand playerCard3 Electric');

const card4 = new Mesh(cardGeo, card4Mat);
maximum1 = myCardsPositions.length - 1;
randomNumber1 = Math.floor(Math.random() * (maximum1 - minimum + 1)) + minimum;
configureCard(card4, myCardsPositions, myCardsRotations, randomNumber1, 'hand playerCard4 Electric');

const card5 = new Mesh(cardGeo, card5Mat);
maximum1 = myCardsPositions.length - 1;
randomNumber1 = Math.floor(Math.random() * (maximum1 - minimum + 1)) + minimum;
configureCard(card5, myCardsPositions, myCardsRotations, randomNumber1, 'hand playerCard5 Electric');
...
configureCard(card6, opponentCardsPositions, opponentCardsRotations, randomNumber2, 'Fire');
...
configureCard(card7, opponentCardsPositions, opponentCardsRotations, randomNumber2, 'Electric');

const card8 = new Mesh(cardGeo, card3Mat);
maximum2 = opponentCardsPositions.length - 1;
randomNumber2 = Math.floor(Math.random() * (maximum2 - minimum + 1)) + minimum;
configureCard(card8, opponentCardsPositions, opponentCardsRotations, randomNumber2, 'Electric');

const card9 = new Mesh(cardGeo, card4Mat);
maximum2 = opponentCardsPositions.length - 1;
randomNumber2 = Math.floor(Math.random() * (maximum2 - minimum + 1)) + minimum;
configureCard(card9, opponentCardsPositions, opponentCardsRotations, randomNumber2, 'Electric');

const card10 = new Mesh(cardGeo, card5Mat);
maximum2 = opponentCardsPositions.length - 1;
randomNumber2 = Math.floor(Math.random() * (maximum2 - minimum + 1)) + minimum;
configureCard(card10, opponentCardsPositions, opponentCardsRotations, randomNumber2, 'Electric');




export {CARDS, waterTexture, fireTexture}